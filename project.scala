...
//> using dep "de.lhns::fs2-compress-zip:2.3.2"
//> using dep "org.apache.maven:maven-resolver-provider:3.9.12"
//> using dep "org.apache.maven.resolver:maven-resolver-supplier:1.9.25"
// same version as maven
//> using dep "org.codehaus.plexus:plexus-xml:4.1.1"
...
//> using test.dep "com.reposilite:reposilite:3.5.26"
